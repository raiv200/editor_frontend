...
export default function RfpEditorPage({ params }: PageProps) {
  ...
  // Save answer handler - memoized with activeQuestionId
              ...
              <div className="max-w-4xl mx-auto">
                ...
                {collabToken ? (
                  loadingAnswer ? (
                    ...
                    <CollaborativeEditor
                      // KEY CHANGE: Use a stable key per RFP, not per question
                      // This prevents WebSocket reconnection on every question switch
                      key={`rfp-${rfpId}`}
